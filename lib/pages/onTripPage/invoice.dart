                  ...
                  Button(
                      onTap: () async {
                        if (userRequestData['payment_opt'] == '0' &&
                          ...
                          //TODO (abdelaziz): Call payment screen
                          // PaymentScreen.navigate(context, amount: amount)
                          setState(() {
                            _isLoading = false;
                            // _choosePayment = true;
                          });

                          addMoney = double.parse(userRequestData['requestBill']
                                  ['data']['total_amount']
                              .toStringAsFixed(2));
                          val = await PaymentScreen.navigate(
                            context,
                            amount: addMoney,
                            isPay: true,
                          );
